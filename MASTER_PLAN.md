...
| 18.1.3 | **"Happening Now" live indicator** — pulsing black dot + "LIVE" text on events currently in progress | P1 | ☐ |
| 18.1.4 | **Event countdown** — live countdown timer on event detail page | P1 | ☐ |
