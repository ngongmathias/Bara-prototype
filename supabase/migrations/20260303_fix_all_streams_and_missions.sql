...
-- ============================================
-- 0. CORE STREAMS TABLES (create if they don't exist)
-- ============================================
...
CREATE POLICY "Public can view public playlists" ON public.playlists FOR SELECT USING (is_public = true);
DROP POLICY IF EXISTS "Users can manage own playlists" ON public.playlists;
CREATE POLICY "Users can manage own playlists" ON public.playlists FOR ALL USING (true);
...
CREATE POLICY "Users can manage playlist songs" ON public.playlist_songs FOR ALL USING (true);
