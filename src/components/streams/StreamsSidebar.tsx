import { Home, Search, Library, Plus, Heart, Globe, Mic2, Film, BookOpen, Headphones, Gamepad2, BarChart3, TrendingUp } from 'lucide-react';
    ...
    return (
        <div className={`bg-white text-gray-600 flex flex-col gap-2 p-2 ${className}`}>
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                ...
                <SidebarLink to="/streams/charts" icon={<TrendingUp size={24} />} label="Charts" active={isActive('/streams/charts')} />
