...
export const MotorsDetail = () => {
  ...
  const handleWhatsAppContact = () => {
    if (listing?.seller_whatsapp) {
      const message = encodeURIComponent(`Hi, I'm interested in your vehicle: ${listing.title}`);
  ...
  const handleEmailContact = () => {
    if (listing?.seller_email) {
      ...
      const body = encodeURIComponent(`Hi,\n\nI'm interested in your vehicle "${listing.title}".\n\nPlease provide more details.\n\nThank you!`);
  ...
  // Extract vehicle-specific attributes
  const make = listing.attributes?.make || 'N/A';
  const model = listing.attributes?.model || 'N/A';
  const year = listing.attributes?.year || 'N/A';
  const mileage = listing.attributes?.mileage || listing.attributes?.kilometers || 'N/A';
  const fuelType = listing.attributes?.fuel_type || 'N/A';
  const transmission = listing.attributes?.transmission || 'N/A';
  const bodyType = listing.attributes?.body_type || 'N/A';
  const color = listing.attributes?.color || 'N/A';
  const engineSize = listing.attributes?.engine_size || 'N/A';
  const doors = listing.attributes?.doors || 'N/A';
  const seats = listing.attributes?.seats || 'N/A';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
              ...
              {listing.images && listing.images.length > 1 && (
                <div className="p-4 grid grid-cols-5 gap-2">
                  {listing.images.slice(0, 10).map((image: any, index: number) => (
                    <button
                      key={image.id}
            ...
            {/* Key Specs - Vehicle Specific */}
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Vehicle Specifications</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <div className="text-xl font-bold text-gray-900">{mileage}</div>
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <div className="text-lg font-bold text-gray-900 capitalize">{fuelType}</div>
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    <div className="text-lg font-bold text-gray-900 capitalize">{transmission}</div>
                    <div className="text-sm text-gray-600">Trans.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Vehicle Overview */}
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Overview</h2>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  ...
                  <span className="font-medium text-gray-900 capitalize">{bodyType}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600 flex items-center gap-2">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  ...
                  <span className="font-medium text-gray-900">{engineSize}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
            ...
            {features.length > 0 && (
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Features & Options</h2>
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {relatedListings.map((item) => {
                ...
                const itemYear = item.attributes?.year || '';
                const itemMake = item.attributes?.make || '';
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <h3 className="font-medium text-gray-900 mb-1">
                        {itemYear} {itemMake} {itemModel}
                      </h3>
                      <div className="text-sm text-gray-600 mb-2">
                        {item.attributes?.mileage} • {item.attributes?.fuel_type}
                      </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold">Report Vehicle</h3>
                <button
                  onClick={() => setShowReportModal(false)}
              ...
              <p className="text-gray-600 mb-4">
                Please tell us why you're reporting this vehicle
              </p>
              <textarea
                value={reportReason}
