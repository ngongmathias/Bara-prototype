...
export const KidsDetail = () => {
  ...
  const handleWhatsAppContact = () => {
    if (listing?.seller_whatsapp) {
      const message = encodeURIComponent(`Hi, I'm interested in your kids item: ${listing.title}`);
  ...
  const handleEmailContact = () => {
    if (listing?.seller_email) {
      ...
      const body = encodeURIComponent(`Hi,\n\nI'm interested in your kids item "${listing.title}".\n\nPlease provide more details.\n\nThank you!`);
  ...
  const itemType = listing.attributes?.item_type || 'N/A';
  const ageRange = listing.attributes?.age_range || 'N/A';
  ...
  const safetyCertified = listing.attributes?.safety_certified || 'N/A';
              ...
              <div className="relative aspect-square bg-gray-100">
                {primaryImage ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <Baby className="w-24 h-24 text-gray-300" />
                  </div>
                )}
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  ...
                  <span className="font-medium text-gray-900 capitalize">{itemType.replace('_', ' ')}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Check for safety certifications</li>
                <li>• Inspect for small parts (choking hazard)</li>
                <li>• Verify age appropriateness</li>
                <li>• Check for recalls</li>
                <li>• Ensure item is clean and sanitized</li>
              </ul>
            </div>
          </div>
        </div>
                  ...
                  >
                    <div className="relative w-full h-48 bg-gray-100">
                      {itemImage ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <Baby className="w-12 h-12 text-gray-300" />
                        </div>
                      )}
                    </div>
                    <div className="p-4">
                      ...
                      <div className="text-sm text-gray-600 mb-2">
                        {item.attributes?.age_range} • {item.attributes?.brand}
                      </div>
