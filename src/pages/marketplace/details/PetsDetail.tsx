...
export const PetsDetail = () => {
  ...
  const handleWhatsAppContact = () => {
    if (listing?.seller_whatsapp) {
      const message = encodeURIComponent(`Hi, I'm interested in your pet: ${listing.title}`);
  ...
  const handleEmailContact = () => {
    if (listing?.seller_email) {
      ...
      const body = encodeURIComponent(`Hi,\n\nI'm interested in your pet "${listing.title}".\n\nPlease provide more details.\n\nThank you!`);
  ...
  const petType = listing.attributes?.pet_type || 'N/A';
  const breed = listing.attributes?.breed || 'N/A';
  const age = listing.attributes?.age || 'N/A';
  const gender = listing.attributes?.gender || 'N/A';
  const color = listing.attributes?.color || 'N/A';
  const vaccinated = listing.attributes?.vaccinated || 'N/A';
  const pedigree = listing.attributes?.pedigree || 'N/A';
  const trained = listing.attributes?.trained || 'N/A';
  const healthStatus = listing.attributes?.health_status || 'N/A';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Pet Information</h2>
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600">Type</span>
                  <span className="font-medium text-gray-900 capitalize">{petType}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600 flex items-center gap-2">
                    <Shield className="w-4 h-4" /> Vaccinated
                  </span>
                  <span className="font-medium text-gray-900 capitalize">{vaccinated}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600">Pedigree</span>
                  <span className="font-medium text-gray-900 capitalize">{pedigree}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600">Trained</span>
                  <span className="font-medium text-gray-900 capitalize">{trained}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3 col-span-2">
                  <span className="text-gray-600 flex items-center gap-2">
                    <Activity className="w-4 h-4" /> Health Status
                  </span>
                  <span className="font-medium text-gray-900 capitalize">{healthStatus.replace('_', ' ')}</span>
                </div>
              </div>
            </div>
            ...
            {features.length > 0 && (
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Characteristics</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Meet the pet before adopting</li>
                <li>• Verify health and vaccination records</li>
                <li>• Ask about temperament and behavior</li>
                <li>• Ensure you can provide proper care</li>
                <li>• Consider adoption fees carefully</li>
              </ul>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="text-sm text-gray-600 mb-2 capitalize">
                        {item.attributes?.breed} • {item.attributes?.age}
                      </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold">Report Pet Listing</h3>
                <button
                  onClick={() => setShowReportModal(false)}
              ...
              <p className="text-gray-600 mb-4">
                Please tell us why you're reporting this pet listing
              </p>
              <textarea
                value={reportReason}
