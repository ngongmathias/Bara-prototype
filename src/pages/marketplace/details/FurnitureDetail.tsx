...
export const FurnitureDetail = () => {
  ...
  const handleWhatsAppContact = () => {
    if (listing?.seller_whatsapp) {
      const message = encodeURIComponent(`Hi, I'm interested in your furniture: ${listing.title}`);
  ...
  const handleEmailContact = () => {
    if (listing?.seller_email) {
      ...
      const body = encodeURIComponent(`Hi,\n\nI'm interested in your furniture "${listing.title}".\n\nPlease provide more details.\n\nThank you!`);
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Furniture Not Found</h1>
  ...
  const furnitureType = listing.attributes?.furniture_type || 'N/A';
  const material = listing.attributes?.material || 'N/A';
  const color = listing.attributes?.color || 'N/A';
  const dimensions = listing.attributes?.dimensions || 'N/A';
  const assemblyRequired = listing.attributes?.assembly_required || 'N/A';
  const room = listing.attributes?.room || 'N/A';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Furniture Details</h2>
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600 flex items-center gap-2">
                    <Package className="w-4 h-4" /> Type
                  </span>
                  <span className="font-medium text-gray-900 capitalize">{furnitureType}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  ...
                  <span className="font-medium text-gray-900 capitalize">{assemblyRequired}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600 flex items-center gap-2">
                    <Home className="w-4 h-4" /> Room
                  </span>
                  <span className="font-medium text-gray-900 capitalize">{room.replace('_', ' ')}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200 sticky top-4">
              ...
              <div className="text-xl font-semibold text-gray-900 mb-2 capitalize">
                {furnitureType}
              </div>
              <div className="text-sm text-gray-600 mb-6">
                {material} • {color} • {listing.condition}
              </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Inspect furniture condition carefully</li>
                <li>• Measure your space before buying</li>
                <li>• Check assembly requirements</li>
                <li>• Arrange safe delivery/pickup</li>
                <li>• Test functionality if possible</li>
              </ul>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="text-sm text-gray-600 mb-2 capitalize">
                        {item.attributes?.furniture_type} • {item.attributes?.material}
                      </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold">Report Furniture</h3>
                <button
                  onClick={() => setShowReportModal(false)}
              ...
              <p className="text-gray-600 mb-4">
                Please tell us why you're reporting this furniture
              </p>
              <textarea
                value={reportReason}
