...
export const HobbiesDetail = () => {
  ...
  const handleWhatsAppContact = () => {
    if (listing?.seller_whatsapp) {
      const message = encodeURIComponent(`Hi, I'm interested in your item: ${listing.title}`);
  ...
  const handleEmailContact = () => {
    if (listing?.seller_email) {
      ...
      const body = encodeURIComponent(`Hi,\n\nI'm interested in your item "${listing.title}".\n\nPlease provide more details.\n\nThank you!`);
  ...
  const hobbyType = listing.attributes?.hobby_type || 'N/A';
  const itemCategory = listing.attributes?.item_category || 'N/A';
  ...
  const rarity = listing.attributes?.rarity || 'N/A';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Item Details</h2>
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600">Hobby Type</span>
                  <span className="font-medium text-gray-900 capitalize">{hobbyType.replace('_', ' ')}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600">Category</span>
                  <span className="font-medium text-gray-900 capitalize">{itemCategory}</span>
                </div>
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                  <span className="text-gray-600 flex items-center gap-2">
                    <Star className="w-4 h-4" /> Rarity
                  </span>
                  <span className="font-medium text-gray-900 capitalize">{rarity.replace('_', ' ')}</span>
                </div>
            ...
            {features.length > 0 && (
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <h2 className="text-xl font-bold text-gray-900 mb-4 font-comfortaa">Features & Highlights</h2>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200 sticky top-4">
              ...
              <div className="text-xl font-semibold text-gray-900 mb-2">
                {brand !== 'N/A' ? brand : itemCategory}
              </div>
              <div className="text-sm text-gray-600 mb-6 capitalize">
                {hobbyType.replace('_', ' ')} • {rarity.replace('_', ' ')} • {listing.condition}
              </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Verify authenticity for collectibles</li>
                <li>• Check condition carefully</li>
                <li>• Ask for provenance if rare</li>
                <li>• Research market value</li>
                <li>• Ensure proper packaging for shipping</li>
              </ul>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="text-sm text-gray-600 mb-2 capitalize">
                        {item.attributes?.hobby_type?.replace('_', ' ')}
                      </div>
