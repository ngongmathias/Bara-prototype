...
export const ServicesDetail = () => {
  ...
  const handleWhatsAppContact = () => {
    if (listing?.seller_whatsapp) {
      const message = encodeURIComponent(`Hi, I'm interested in your service: ${listing.title}`);
  ...
  const handleEmailContact = () => {
    if (listing?.seller_email) {
      const subject = encodeURIComponent(`Service Inquiry: ${listing.title}`);
      const body = encodeURIComponent(`Hi,\n\nI'm interested in your service "${listing.title}".\n\nPlease provide more details.\n\nThank you!`);
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold">Report Service</h3>
                <button
                  onClick={() => setShowReportModal(false)}
              ...
              <p className="text-gray-600 mb-4">
                Please tell us why you're reporting this service
              </p>
              <textarea
                value={reportReason}
