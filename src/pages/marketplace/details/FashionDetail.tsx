...
export const FashionDetail = () => {
  ...
  const {
    ...
    itemNoun: 'item',
    source: 'fashion_detail_page',
    whatsappMessage: (l) => `Hi, I'm interested in your ${l.title}`,
  });
                ...
                <div className="p-4 flex gap-2 overflow-x-auto">
                  {listing.images.map((image: any, index: number) => (
                    <button
                      ...
                      className={`flex-shrink-0 w-20 h-24 rounded border-2 overflow-hidden ${index === currentImageIndex ? 'border-blue-600' : 'border-gray-200'
                        }`}
                    >
                      <img
                        src={image.image_url}
