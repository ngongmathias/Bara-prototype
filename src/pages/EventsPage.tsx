  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row">
        {/* Left Sidebar - Filters (sticky on desktop, scrolls independently) */}
        <aside className="w-full lg:w-96 bg-white border-r border-gray-200 lg:sticky lg:top-0 lg:self-start lg:max-h-screen overflow-y-auto scrollbar-hide" style={{scrollbarWidth: 'none', msOverflowStyle: 'none'}}>
