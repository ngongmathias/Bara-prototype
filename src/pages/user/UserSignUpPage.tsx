        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          {step === 'form' ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Google is offered first — most users would rather not invent
                  a password they'll forget. Reuses the details entered above
                  (validated + stashed in handleGoogle) so nothing is re-typed
                  after the OAuth redirect. */}
              <div className="relative pt-2">
                <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-200" /></div>
                <div className="relative flex justify-center text-xs"><span className="px-2 bg-white text-gray-400">continue with</span></div>
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-black hover:bg-gray-800 text-white rounded-md py-2.5 px-4 text-sm font-semibold transition-colors disabled:opacity-50"
              >
              ...
              <div className="relative pt-2">
                <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-200" /></div>
                <div className="relative flex justify-center text-xs"><span className="px-2 bg-white text-gray-400">or set a password</span></div>
              </div>
              ...
              <button
                ...
                className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-2.5 px-4 rounded-md transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
              >
