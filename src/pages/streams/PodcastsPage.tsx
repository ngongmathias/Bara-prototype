        ...
        <StreamsLayout>
            <div className="min-h-screen bg-gray-50 pb-24">
                    ...
                    <div className="relative max-w-4xl mx-auto px-6 pt-12 pb-8 text-center">
                        ...
                        <div className="flex flex-wrap justify-center gap-2 mb-8">
                            {['African Stories', 'True Crime', 'Comedy', 'Tech', 'Finance', 'Sports', 'Music News', 'Self-Improvement'].map((cat) => (
                                <span key={cat} className="bg-gray-100 text-gray-600 text-xs font-bold px-3 py-1.5 rounded-full border border-gray-100">
                                    {cat}
                                </span>
                            ))}
                        </div>
                ...
                <div className="max-w-4xl mx-auto px-6 mt-4">
                    <h2 className="text-xl font-bold text-gray-900 mb-1">Preview: What's Coming</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {SAMPLE_PODCASTS.map((pod) => (
                            <div key={pod.title} className="bg-white border border-gray-100 rounded-xl overflow-hidden border border-gray-100 hover:border-gray-200 transition group">
                                <div className={`h-28 bg-gradient-to-br ${pod.color} flex items-center justify-center relative`}>
                                    <Mic2 size={40} className="text-gray-900/30" />
                                    <div className="absolute bottom-2 right-2 w-10 h-10 bg-black/40 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition">
                                        <Play size={16} className="text-gray-900 ml-0.5" fill="white" />
                                    </div>
                                </div>
                                <div className="p-4">
                ...
                <div className="max-w-4xl mx-auto px-6 mt-12">
                    <h2 className="text-xl font-bold text-gray-900 mb-6">How Bara Podcasts Will Work</h2>
